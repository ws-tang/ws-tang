...
- The Udemy course [**Kubernetes Certified Application Developer (CKAD) with Tests**](https://www.udemy.com/course/certified-kubernetes-application-developer/) by **Mumshad Mannambeth**, **KodeKloud Training**, and **Vijin Palazhi** (This is a paid course.)
