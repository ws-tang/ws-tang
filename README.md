...
- SOAP web services for SSL certificate management and session data queries.
- the shell scripts:
  - to generate system default SSL certificates per installation.
  - to clear orphaned data entries in Postgres database.
  - to clear old entries of third-party software after upgrades.
...
- [Certificate and Learning](#certs_and_learning)
...
## Certificate and Learning <a name="certs_and_learning"></a>
...
My development environment is detailed at [dev](dev/devenv.md).
...
## Software Development <a name="sw_dev"></a>

See the notes about software development [here](dev/devenv.md).
...
See the notes about data structures and algorithms [here](dev/dsandalgos.md).
